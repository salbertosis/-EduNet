...
const ModalAsignarPgcrpEstudiantes: React.FC<ModalAsignarPgcrpEstudiantesProps> = ({
  ...
  const getEstadoPgcrp = (estudiante: EstudiantePgcrpDetalle) => {
    if (estudiante.actividad_pgcrp) {
      return {
        tipo: 'Individual',
        actividad: estudiante.actividad_pgcrp,
        color: 'text-blue-600 bg-blue-50',
      };
    } else if (estudiante.actividad_seccion) {
      return {
        tipo: 'Por Sección',
        actividad: estudiante.actividad_seccion,
          ...
          <div className="flex h-[calc(80vh-70px)]">
            ...
            <div className="w-1/2 border-r border-gray-200 flex flex-col">
              <div className="p-3 border-b border-gray-200">
                <h3 className="font-semibold text-gray-800 mb-2 text-sm">Estudiantes</h3>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-xs text-gray-600 mt-0.5 max-w-20 truncate">
                            {estado.actividad}
                          </p>
                        </div>
                      </div>
                ...
                <>
                  ...
                  <div className="p-3 border-b border-gray-200">
                    ...
                    <div className="space-y-1 max-h-24 overflow-y-auto">
                      <label className="flex items-center space-x-2 p-1.5 rounded-md hover:bg-gray-50 cursor-pointer">
                        <input
                          type="radio"
                          name="actividad"
                          value=""
                        ...
                        />
                        <span className="text-gray-700 text-sm">Sin asignación individual</span>
                      </label>
                      {actividadesFiltradas.map((actividad) => (
                        <label
                          key={actividad.id_extra_catedra}
                          className="flex items-center space-x-2 p-1.5 rounded-md hover:bg-gray-50 cursor-pointer"
                        >
                          <input
                            type="radio"
                            name="actividad"
                            ...
                            className="text-blue-600 focus:ring-blue-500"
                          />
                          <span className="text-gray-700 text-sm">{actividad.nombre}</span>
                        </label>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="flex-1 p-3 border-b border-gray-200">
                    ...
                    <textarea
                      ...
                      className="w-full h-16 p-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
                    />
                  </div>
